/*
# Consolidated Schema — All Tables, RLS, Storage, Triggers

This combines all 5 prior migrations into one idempotent script.
Creates: profiles, markets, analysis, charts, blog_posts, journal_trades,
notifications, social_links, support_tickets, pdf_reports, news, premium_analysis.
Creates uploads storage bucket with policies.
Creates handle_new_user + set_updated_at trigger functions with fixed search_path.
*/
...
CREATE POLICY "select_own_profile" ON profiles FOR SELECT TO authenticated USING (auth.uid() = id OR EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role = 'admin'));
...
CREATE POLICY "public_read_markets" ON markets FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "admin_insert_markets" ON markets;
CREATE POLICY "admin_insert_markets" ON markets FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_markets" ON markets;
CREATE POLICY "admin_update_markets" ON markets FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_markets" ON markets;
CREATE POLICY "admin_delete_markets" ON markets FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "public_read_analysis" ON analysis FOR SELECT TO anon, authenticated USING (status = 'published');
DROP POLICY IF EXISTS "admin_insert_analysis" ON analysis;
CREATE POLICY "admin_insert_analysis" ON analysis FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_analysis" ON analysis;
CREATE POLICY "admin_update_analysis" ON analysis FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_analysis" ON analysis;
CREATE POLICY "admin_delete_analysis" ON analysis FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "public_read_charts" ON charts FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "admin_insert_charts" ON charts;
CREATE POLICY "admin_insert_charts" ON charts FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_charts" ON charts;
CREATE POLICY "admin_update_charts" ON charts FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_charts" ON charts;
CREATE POLICY "admin_delete_charts" ON charts FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "public_read_blog" ON blog_posts FOR SELECT TO anon, authenticated USING (status = 'published');
DROP POLICY IF EXISTS "admin_insert_blog" ON blog_posts;
CREATE POLICY "admin_insert_blog" ON blog_posts FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_blog" ON blog_posts;
CREATE POLICY "admin_update_blog" ON blog_posts FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_blog" ON blog_posts;
CREATE POLICY "admin_delete_blog" ON blog_posts FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "select_own_journal" ON journal_trades FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "insert_own_journal" ON journal_trades;
CREATE POLICY "insert_own_journal" ON journal_trades FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "update_own_journal" ON journal_trades;
CREATE POLICY "update_own_journal" ON journal_trades FOR UPDATE TO authenticated USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "delete_own_journal" ON journal_trades;
CREATE POLICY "delete_own_journal" ON journal_trades FOR DELETE TO authenticated USING (auth.uid() = user_id);
...
CREATE POLICY "admin_insert_social" ON social_links FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role = 'admin'));
DROP POLICY IF EXISTS "admin_update_social" ON social_links;
CREATE POLICY "admin_update_social" ON social_links FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role = 'admin')) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role = 'admin'));
DROP POLICY IF EXISTS "admin_delete_social" ON social_links;
CREATE POLICY "admin_delete_social" ON social_links FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role = 'admin'));
...
CREATE POLICY "select_own_support_tickets" ON support_tickets FOR SELECT TO authenticated USING (auth.uid() = user_id OR EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role = 'admin'));
...
CREATE POLICY "public_read_pdf_reports" ON pdf_reports FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS "admin_insert_pdf_reports" ON pdf_reports;
CREATE POLICY "admin_insert_pdf_reports" ON pdf_reports FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_pdf_reports" ON pdf_reports;
CREATE POLICY "admin_update_pdf_reports" ON pdf_reports FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_pdf_reports" ON pdf_reports;
CREATE POLICY "admin_delete_pdf_reports" ON pdf_reports FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "public_read_news" ON news FOR SELECT TO anon, authenticated USING (status = 'published');
DROP POLICY IF EXISTS "admin_insert_news" ON news;
CREATE POLICY "admin_insert_news" ON news FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_news" ON news;
CREATE POLICY "admin_update_news" ON news FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_news" ON news;
CREATE POLICY "admin_delete_news" ON news FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "public_read_premium" ON premium_analysis FOR SELECT TO anon, authenticated USING (status = 'published');
DROP POLICY IF EXISTS "admin_insert_premium" ON premium_analysis;
CREATE POLICY "admin_insert_premium" ON premium_analysis FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_update_premium" ON premium_analysis;
CREATE POLICY "admin_update_premium" ON premium_analysis FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "admin_delete_premium" ON premium_analysis;
CREATE POLICY "admin_delete_premium" ON premium_analysis FOR DELETE TO authenticated USING (EXISTS (SELECT 1 FROM profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
...
CREATE POLICY "Admin upload uploads" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'uploads' AND EXISTS (SELECT 1 FROM public.profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "Admin update uploads" ON storage.objects;
CREATE POLICY "Admin update uploads" ON storage.objects FOR UPDATE TO authenticated USING (bucket_id = 'uploads' AND EXISTS (SELECT 1 FROM public.profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst'))) WITH CHECK (bucket_id = 'uploads' AND EXISTS (SELECT 1 FROM public.profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
DROP POLICY IF EXISTS "Admin delete uploads" ON storage.objects;
CREATE POLICY "Admin delete uploads" ON storage.objects FOR DELETE TO authenticated USING (bucket_id = 'uploads' AND EXISTS (SELECT 1 FROM public.profiles p WHERE p.id = auth.uid() AND p.role IN ('admin', 'analyst')));
